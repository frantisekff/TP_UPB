...
<!DOCTYPE html>
<t:layout>
    <jsp:attribute name = "title" >Files - Zadanie UPB</jsp:attribute>
    <jsp:body>
        ...
        <sql:query dataSource = "${FileDB}" var = "result" sql="SELECT F.*, COUNT(C.COMMENT_ID) NUMCOMMENTS from FILES F LEFT JOIN COMMENTS C ON F.ID = C.FILE_ID GROUP BY F.ID"></sql:query>
